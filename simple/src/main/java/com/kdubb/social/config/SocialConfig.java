 ...
 */
package com.kdubb.social.config;
...
import com.kdubb.social.user.SecurityContext;
import com.kdubb.social.user.SimpleConnectionSignUp;
import com.kdubb.social.user.SimpleSignInAdapter;
import com.kdubb.social.user.User;
...
public class SocialConfig {
	...
	public ConnectionFactoryLocator connectionFactoryLocator() {
		...
		registry.addConnectionFactory(new FacebookConnectionFactory(0
